...
/**
 * Servlet implementation class UserRegiResult
 */
@WebServlet("/UserRegiCheckServlet")
public class UserRegiCheckServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//userRegi.jspにフォワード
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/userRegi/userRegi.jsp");
...
//			ch = false;
//		} else if(((CharSequence) account.getBirth()).length() != 8 ) {
//			errormsg += "例示を参考に8桁で生年月日を入力してください。";
//			ch = false;
//		}
...
//		}
		...
		if(ch) {
			//userRegiCheck.jspにフォワード
			RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/jsp/userRegi/userRegiCheck.jsp");
			dispatcher.forward(request, response);
		} else { //入力内容に不備がある場合は再入力してもらう
