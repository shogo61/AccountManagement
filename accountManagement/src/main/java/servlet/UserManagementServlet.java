	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        case 1:	//削除確認画面
            ...
            Account AccountDelete = new Account(managementAccount.getId(), managementAccount.getPass(), managementAccount.getName(), 
            		managementAccount.getBirth(), managementAccount.getMail(), managementAccount.getTel(), managementAccount.getRole(), active);
        ...
        case 3:	//変更確認画面
    		...
    		//変更完了画面へフォワードする
    		RequestDispatcher dispatcher3 = request.getRequestDispatcher("/WEB-INF/jsp/userManagement/edit/deleteResult.jsp");
